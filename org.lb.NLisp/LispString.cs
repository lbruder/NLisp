...
namespace org.lb.NLisp
{
    internal sealed class LispString : LispObject, IEnumerable<LispObject>
    {
        ...
        internal override LispObject Add(LispObject other) { return new LispString(value + OtherString(other, "+")); }
        internal override LispObject NumEq(LispObject other) { return FromClrObject(String.CompareOrdinal(value, OtherString(other, "=")) == 0); }
        internal override LispObject Lt(LispObject other) { return FromClrObject(String.CompareOrdinal(value, OtherString(other, "<")) < 0); }
        internal override LispObject Gt(LispObject other) { return FromClrObject(String.CompareOrdinal(value, OtherString(other, ">")) > 0); }
