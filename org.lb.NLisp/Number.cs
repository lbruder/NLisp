...
namespace org.lb.NLisp
{
    internal sealed class Number : LispObject
    {
        ...
        internal override LispObject Div(LispObject other) { if (OtherNumber(other, "/") == 0) throw new DivisionByZeroException(); return new Number(number / OtherNumber(other, "/")); }
        internal override LispObject Mod(LispObject other) { if (OtherNumber(other, "mod") == 0) throw new DivisionByZeroException(); return new Number(number % OtherNumber(other, "mod")); }
